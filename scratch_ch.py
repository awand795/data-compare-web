...
query_ch('SELECT count() FROM `cdc_demo-erp_sch_erp_inventory_trd_penerimaan_lain`')
query_ch('SELECT count() FROM `cdc_demo-erp_sch_erp_inventory_trh_penerimaan_lain`')
query_ch('SELECT count() FROM `dwh_penerimaan_lain_v4`')
