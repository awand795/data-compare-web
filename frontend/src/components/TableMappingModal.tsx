    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-bg-panel border border-border-main rounded-xl shadow-2xl w-full max-w-[850px] flex flex-col text-text-main max-h-[90vh] overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-5 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
                <div className="grid grid-cols-[1fr_auto_1fr] gap-3 items-end">
                  <div className="flex flex-col">
                    ...
                    <datalist id="source-tables-list">{sourceTables.map(t => <option key={t} value={t} />)}</datalist>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <datalist id="target-tables-list">{targetTables.map(t => <option key={t} value={t} />)}</datalist>
                  </div>
                </div>
            ...
            >
              ...
              {showAdvanced ? 'Hide' : 'Show'} Advanced Options (Primary Keys, Exclude Columns)
            </button>
        ...
        <div className="px-5 py-3.5 border-t border-border-main flex justify-end gap-2 bg-bg-header rounded-b-xl shrink-0">
          <button onClick={onClose} className="px-4 py-2 text-xs font-medium text-text-muted hover:text-text-main hover:bg-bg-hover rounded-md transition-colors">
            Cancel
          </button>
          <button
            onClick={handleSave}
