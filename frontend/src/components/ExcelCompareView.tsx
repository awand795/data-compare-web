        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <div className="flex flex-col">
                ...
                {!excelIsTarget ? (
                  <>
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-blue-500/10 text-blue-500 border border-blue-500/20 rounded-md text-[13px] font-bold hover:bg-blue-500 hover:text-white transition-colors"
                    >
              ...
              <div className="flex flex-col">
                <span className="text-[11px] font-bold text-emerald-500 dark:text-emerald-400 uppercase tracking-wider mb-0.5">
                ...
                {excelIsTarget ? (
                  <>
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 rounded-md text-[13px] font-bold hover:bg-emerald-500 hover:text-white transition-colors"
                    >
                  ...
                  <select
                    className="px-3 py-2 bg-bg-input border border-border-input rounded-md text-[13px] font-medium text-text-input w-52 focus:border-emerald-500 outline-none"
            ...
            <div className="h-full bg-bg-panel flex flex-col">
              <div className="bg-bg-header border-b border-border-main px-3 py-1.5 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-2 text-xs font-semibold text-text-muted uppercase tracking-wider">
                  ...
                  <span className="ml-1 px-1.5 py-0.5 bg-bg-hover rounded text-[10px] text-text-muted">{excelMappings.length}</span>
                </div>
