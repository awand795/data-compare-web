...
import { 
  ...
  ChevronDown, ChevronRight, CheckSquare, Square, ArrowUpDown, ArrowUp, ArrowDown
} from 'lucide-react';
...
export const ScheduleManagerView: React.FC = () => {
    ...
    const displayedGroups = useMemo(() => {
        ...
        return groupsToConsider.map(grp => {
            const rawItems = filteredSchedules.filter(s => getJobGroupName(s.groupName) === grp);
    ...
    }, [allGroups, filteredSchedules, selectedGroup, searchQuery, schedules, groupSort]);
                                            ...
                                            <button
                                                ...
                                                className={clsx(
                                                    ...
                                                    groupSort[group.groupName]
                                                        ...
                                                        : "bg-bg-main hover:bg-bg-hover text-text-muted hover:text-text-main border-border-main"
                                                )}
                                                title={
                                                        ...
                                                        <thead className="bg-bg-header text-[10px] text-text-muted uppercase tracking-wider border-b border-border-main sticky top-0 z-10">
                                                            <tr>
                                                                ...
                                                                <th 
                                                                    ...
                                                                    className="py-3 px-4 font-bold cursor-pointer select-none hover:text-text-main transition-colors group/th"
                                                                    title={
                                                                        groupSort[group.groupName] === 'asc'
                                                                ...
                                                                >
                                                                    <div className="flex items-center gap-1.5">
                                                                        ...
                                                                        {groupSort[group.groupName] && (
                                                                            <span className="text-[9px] font-mono px-1 py-0.2 rounded bg-purple-500/20 text-purple-300 font-bold">
