        ...
        <div className="flex-1 flex flex-col min-h-0 bg-bg-main relative">
            ...
            {isFormOpen && (
                <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-bg-panel border border-border-main rounded-xl shadow-2xl w-full max-w-[600px] max-h-full flex flex-col">
                        ...
                        <div className="p-5 flex flex-col gap-6 overflow-y-auto min-h-0">
