                            ...
                            {currentStep === 0 && (
                                <div className="flex flex-col gap-5">
                                    ...
                                    <div className="flex justify-end gap-2 mt-2">
                                        <button onClick={() => setIsFormOpen(false)} className="px-4 py-2 text-xs font-semibold border border-slate-500/30 bg-slate-500/15 text-slate-400 hover:bg-slate-500/25 hover:text-slate-300 rounded-lg transition-colors">Cancel</button>
